...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link EarthquakeActivity} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<EarthquakeActivity> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<EarthquakeActivity> earthquakes = new ArrayList<>();
